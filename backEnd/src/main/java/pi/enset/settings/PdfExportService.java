...
public class PdfExportService {
    ...
    public void AddPageClasse(Document myPDFDoc, Classe classe) throws IOException {
        ...
        myPDFDoc.addSubject("emplois du temps pour l'FSM");
        myPDFDoc.addKeywords("FSM");
        myPDFDoc.addCreator("FSM");
        myPDFDoc.addAuthor("FSM");
        ...
        float headerHeight = 2000f;  // Adjust the height as needed
        ...
        footerImage.scaleToFit(footerWidth, footerHeight);
        footerImage.scaleToFit(footerWidth, footerHeight);
